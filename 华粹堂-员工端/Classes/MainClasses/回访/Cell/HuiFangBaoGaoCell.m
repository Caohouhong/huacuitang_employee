...
@implementation HuiFangBaoGaoCell

+(instancetype)cellWithTableview:(UITableView *)tableview {
    static NSString *idenifier = @"HuiFangBaoGaoCell";
    HuiFangBaoGaoCell *cell = [tableview dequeueReusableCellWithIdentifier:idenifier];
    if (cell == nil){
        cell = [[HuiFangBaoGaoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:idenifier];
...
-(void)setModel:(HuiFangModel *)model {
    ...
    self.yuYueDateLabel.text = [NSString stringWithFormat:@"预约时间：%@",model.visit_time];
