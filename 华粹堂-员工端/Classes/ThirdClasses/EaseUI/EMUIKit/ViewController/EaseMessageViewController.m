...
- (void)_sendMessage:(EMMessage *)message
{
    ...
    message.ext = [self extentionMessage];
...
#pragma mark -
#pragma mark ==================================
-(NSMutableDictionary *)extentionMessage
{
    NSMutableDictionary *dic = [NSMutableDictionary dictionary];
    [dic setValue:[ModelMember sharedMemberMySelf].memberId forKey:@"senderMemberId"];
    [dic setValue:[ModelMember sharedMemberMySelf].name forKey:@"senderName"];
    
    if ([ModelMember sharedMemberMySelf].portrait.length) {
        [dic setValue:[ModelMember sharedMemberMySelf].portrait forKey:@"senderPortrait"];
    }
    if (self.receiverMemberId.length) {
        [dic setValue:self.receiverPortrait forKey:@"receiverMemberId"];
    }
    if (self.receiverPortrait.length) {
        [dic setValue:self.receiverPortrait forKey:@"receiverPortrait"];
    }
    if (self.receiverName.length) {
        [dic setValue:self.receiverName forKey:@"receiverName"];
    }
    if (self.receiverPhone.length) {
        [dic setValue:self.receiverName forKey:@"receiverPhone"];
    }
    if ([ModelMember sharedMemberMySelf].telephone.length) {
        [dic setValue:[ModelMember sharedMemberMySelf].telephone forKey:@"senderPhone"];
    }
...
- (void)callPhone
{
    if(self.receiverPhone.length)
    {
        NSString *num = [[NSString alloc]initWithFormat:@"telprompt://%@",self.receiverPhone];
