...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    [self.avatarView sd_setImageWithURL:[NSURL URLWithString:[ext valueForKey:@"senderPortrait"]] placeholderImage:[UIImage imageNamed:@"default"]];
    
    _nameLabel.text = [ext valueForKey:@"senderName"];
